...
// Skip login-dependent tests if backend is not available
...
test.describe('Visual Regression', () => {
  test('capture landing page', async ({ page }) => {
    ...
    await page.screenshot({ path: 'screenshots/e2e-landing.png', fullPage: true });
  });
  ...
  test('capture login page', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'screenshots/e2e-login.png', fullPage: true });
  });
  ...
  test('capture register page', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'screenshots/e2e-register.png', fullPage: true });
  });
});
